...
public class EmailUtil {
    ...
    public static String getUserRegisterTemplate(String token, String code) {
        return "<h3>Completa tu registro en el siguiente <a href=\"https://listore-nine.vercel.app/pages/auth/passwordChange?token="+token+"\"> enlace</a></h3> <h3>Tu código es: " + code + "</h3>";
    }
    ...
    public static String getUserRecoveryTemplate(String token, String code) {
        return "<h3>Recupera tu contraseña en el siguiente <a href=\"https://listore-nine.vercel.app/pages/auth/passwordChange?token="+token+"\"> enlace</a></h3> <h3>Tu código es: " + code + "</h3>";
    }
